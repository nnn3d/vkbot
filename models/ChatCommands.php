    ...
    public static function getAllCommands()
    {
        ...
        $commands[] = new ChatCommand(
            ...
            function ($command) use ($s) {
                $s->load($command);
                return $s->argsEqual(2) && $s->argsRegExp(['кто', 'я']);
            },
            function ($command) {
                ...
                $c_sector = array(1 => "тамплиеров", "сисек", "детей", "ведьмаков", "распродаж", "игр", "школьников", "девчат", "драконов", "некроморфов", "зомби", "сиджеев", "азиатов", "американцев", "старцев", "потомков", "магов", "гоблинов", "призраков", "анусов", "шмар", "шлюх", "бурят", "ингушетиков", "сракотанов", "ебасосин", "козочек", "грудничков", "капибар", "конф");
...
[Команда: $botName брак да \ нет]";
		...
		$kickmass=explode(",", $kicklist);
		    ...
		    $chat->sendMessage("ЩОРСУНЧИК {$kickuser}");
                    $usercall=explode(" ", implode($kickuser));
